...
export default function Navbar({ fixed }) {
  ...
  return (
    <>
      <nav className="relative  text-md flex items-center justify-around lg:justify-between px-2 lg:px-8 py-3 bg-stone-900">
        {getMenu()}
        <a href="/" className="font-bold text-xl text-stone-50">Justin's Sushi</a>
        <div className="icons">
          <a href="#">
...
function getMenu() {
  return (
    <>
      <ul className="font-semibold hidden lg:flex lg:flex-row text-lg text-stone-50">
